...
function NormalBuilding(x, y) {
  ...
  this.draw = function () {
    push();
      ...
      // Door
      fill(142, 72, 46);
      rect(this.x + this.width / 2 - 35, this.y + 380, 70, 100); 
      fill(140);
      ellipse(this.x + this.width / 2, this.y + 420, 10); 
...
function Flag(x, y) {
  ...
  this.draw = function () {
    ...
    // If Police is not near the flag
...
function Enemies(x, y, range, type) {
    ...
    if (gameState == 1) 
      {
        ...
        if (this.type == "red") 
          {
            this.speed = 1; // enemy default speed
          } 
          
        else if (this.type == "blue") 
          {
            this.speed = 3; // enemy speed fasten
          } 
          
        else {
            this.speed = 5; // enemy speed fasten
          }
  ...
  this.draw = function () {
    if (this.incr >= 1) 
      {
        enemyTurnRight(this.currentX, this.y, this.handDeg, this.type); // enemy turn right animation
      } 
    
    else if (this.incr <= -1) 
      {
        enemyTurnLeft(this.currentX, this.y, this.handDeg, this.type); // enemy turn left animation
      }
  };

  this.checkContact = function (p_x, p_y) {

    // If Police hit by enemy
